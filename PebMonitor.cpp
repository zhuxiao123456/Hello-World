...
void ProcessNotifyCallbackEx(
    ...
    // 【修复 2】使用 RtlZeroMemory 彻底清空，并记录实际提取的长度
    ...
    // 2. 准备事件节点
    //PPROCESS_EVENT_NODE node = (PPROCESS_EVENT_NODE)ExAllocatePool2(POOL_FLAG_NON_PAGED, sizeof(PROCESS_EVENT_NODE), 'ndPM');
    // 使用经典的 ExAllocatePoolWithTag 替换 ExAllocatePool2 以兼容老版本 Windows
